...
import os
os.chdir("C:/Users/mital/Downloads/")
...
ensemble_model = VotingClassifier(
    estimators=[('lr', lr), ('nb', nb), ('sgd', sgd)],
    voting='soft'
)

# Fit on training data
ensemble_model.fit(X_train_vectors_tfidf, y_train)

# Predict on test data
ensemble_preds = ensemble_model.predict(X_vector)


# Evaluate
print("Ensemble Model Performance:")
print(classification_report(y_predict, ensemble_preds))
...
# Save this as app.py to run the Streamlit web app
...
if st.button("Classify"):
    ...
    result = "Disaster" if prediction[0] == 1 else "Not Disaster"
